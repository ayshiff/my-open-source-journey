...
<img
  ...
  width="500px"
  src={useBaseUrl('img/lifetime/presentation.png')}
/>
<br/>
<em>LifeTime</em>
</div>
...
<a href="https://reasonml.github.io/"><Highlight color="#25c2a0">ReasonML</Highlight></a> is a programming langugage powered by **OCaml**. (anything possible in OCaml is possible in Reason)

The idea behind Reason is pretty simple: if it compiles it will works ! (99% of the time)

**The example of Messenger.com**
